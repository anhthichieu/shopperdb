const info = {
  ...
  "kids": {
    "categories": ['Jackets', 'Bags', 'Dresses', 'Sneakers', 'Headbands', 'Shoes', 'T-Shirts', 'Hats'],
    'productName': ['GAP checked flannel shacket', 'Circle unicorn bag', 'Dress Green Kids Il Gufo', 'Chromefree White Leather Veja Sneakers With Velcro', 'Turquoise Simonetta Padded Headband', 'Chloé Gold Leather Sandals With Studs', 'T-shirt with print and tank top in foil set', 'Black Cotton Canvas Dsquared2 Baseball Cap']
  }
}
